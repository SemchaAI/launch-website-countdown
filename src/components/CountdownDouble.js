...
export const CountdownDouble = () => {
  //   const targetDate = new Date();
  //   targetDate.setHours(targetDate.getHours() + 5);
  //   const [min, setMin] = useState(targetDate.getMinutes());
  //   const [sec, setSec] = useState(targetDate.getSeconds());
        ...
        <div className="time-group">
          <div className="time-segment">
            <div className="segment-display">
              ...
              <div className={cn("segment-overlay")}>
                <div className="segment-overlay__top">
                  {getTimeRemaining.seconds}
                </div>
                <div className="segment-overlay__bottom">
